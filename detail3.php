...
<body>
  ...
  <center style="font-size:35px;">elzatta Motif</center>
<br>
  <div class="row">
    <div class="col-sm-3">
  ...
  <!-- <div class="row">
    ...
    <div class="col-sm-3">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="assets/img/c5.jpg" alt="Card image" width="50%">
        <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="assets/img/c6.jpg" alt="Card image" width="50%">
        <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="assets/img/c7.jpg" alt="Card image" width="50%">
        <div class="card-body">
          <h4 class="card-title">Satin</h4>
          <p class="card-text">Rp. 79.999,-</p>
          <a href="detail6.php" class="btn btn-primary">See More</a>
  ...
  <!-- <div class="row">
    ...
    <div class="col-sm-3">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="assets/img/c9.jpg" alt="Card image" width="50%">
        <div class="card-body">
          <h4 class="card-title">Scarf</h4>
          <p class="card-text">Rp. 50.999,-</p>
          <a href="detail5.php" class="btn btn-primary">See More</a>
    ...
    <div class="col-sm-3">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="assets/img/c10.jpg" alt="Card image" width="50%">
        <div class="card-body">
          <h4 class="card-title">Satin</h4>
          <p class="card-text">Rp. 79.999,-</p>
          <a href="detail6.php" class="btn btn-primary">See More</a>
    ...
    <div class="col-sm-3">
      <div class="card" style="width:400px">
        <img class="card-img-top" src="assets/img/c11.jpg" alt="Card image" width="50%">
        <div class="card-body">
          <h4 class="card-title">Satin</h4>
          <p class="card-text">Rp. 79.999,-</p>
          <a href="detail6.php" class="btn btn-primary">See More</a>
